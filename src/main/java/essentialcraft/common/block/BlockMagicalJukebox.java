...
public class BlockMagicalJukebox extends BlockContainer implements IModelRegisterer {
	...
	public void registerModels() {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(this), 0, new ModelResourceLocation("essentialcraft:magicaljukebox", "inventory"));
	}
}
