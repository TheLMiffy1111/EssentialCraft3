		...
		if(Loader.isModLoaded("codechickenlib")) {
			ModelLoader.setCustomStateMapper(this, new StateMapperBase() {
				...
				protected ModelResourceLocation getModelResourceLocation(IBlockState state) {
					return new ModelResourceLocation("essentialcraft:crystalcontrollertemp", "normal");
				}
			});
			ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(this), 0, new ModelResourceLocation("essentialcraft:crystalcontrollertemp", "inventory"));
			return;
		}
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(this), 0, new ModelResourceLocation("essentialcraft:crystalcontroller", "inventory"));
	}
}
