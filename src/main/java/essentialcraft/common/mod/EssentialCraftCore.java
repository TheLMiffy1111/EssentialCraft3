...
import essentialcraft.integration.crafttweaker.CraftTweakerUtils;
...
public class EssentialCraftCore {
	...
	public static final String VERSION = "4.9.112.5";
	...
	public void serverStart(FMLServerStartingEvent event) {
		...
		//TODO Merge these commands
		event.registerServerCommand(new CommandSetUBMRU());
		event.registerServerCommand(new CommandCorruptionEffect());
		event.registerServerCommand(new CommandSetWindbound());
		event.registerServerCommand(new CommandSetWindPoints());
	}
