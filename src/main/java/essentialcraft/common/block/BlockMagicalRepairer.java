...
public class BlockMagicalRepairer extends BlockContainer implements IModelRegisterer {
	...
	public void registerModels() {
		if(Loader.isModLoaded("codechickenlib")) {
			...
			ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(this), 0, new ModelResourceLocation("essentialcraft:magicalrepairertemp", "inventory"));
			return;
		}
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(this), 0, new ModelResourceLocation("essentialcraft:magicalrepairer", "inventory"));
	}
}
