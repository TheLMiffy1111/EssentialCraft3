...
public class BlockMonsterHarvester extends BlockContainer implements IModelRegisterer {
	...
	public void registerModels() {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(this), 0, new ModelResourceLocation("essentialcraft:monsterharvester", "inventory"));
	}
}
