...
public class BlockMRUIntersector extends BlockContainer implements IModelRegisterer {

	public BlockMRUIntersector() {
		super(Material.ROCK);
	}
	...
	public void registerModels() {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(this), 0, new ModelResourceLocation("essentialcraft:intersector", "inventory"));
	}
}
