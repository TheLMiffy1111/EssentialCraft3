...
public class BlockWeatherController extends BlockContainer implements IModelRegisterer {

	protected BlockWeatherController() {
		super(Material.ROCK);
	}
	...
	public void registerModels() {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(this), 0, new ModelResourceLocation("essentialcraft:weathercontroller", "inventory"));
	}
}
