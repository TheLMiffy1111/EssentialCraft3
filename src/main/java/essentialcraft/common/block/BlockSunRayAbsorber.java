...
public class BlockSunRayAbsorber extends BlockContainer implements IModelRegisterer {

	protected BlockSunRayAbsorber() {
	...
	public void registerModels() {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(this), 0, new ModelResourceLocation("essentialcraft:sunrayabsorber", "inventory"));
	}
}
